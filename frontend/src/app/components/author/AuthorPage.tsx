...
const AuthorPage: React.FC<IAuthorPage> = ({ slug }) => {
    ...
    return (<> <div className="relative w-full h-64 mb-10 ">
        <div
            className="absolute z-10 inset-0 bg-cover bg-center"
            style={{
                backgroundImage: `url("https://cdn.sanity.io/images/n34jpwpp/production/0a391cbabc1e60c76e8b261bd9ffebb392c31f51-2560x1440.webp")`,
            }}
        ></div>
        <div
            style={{
